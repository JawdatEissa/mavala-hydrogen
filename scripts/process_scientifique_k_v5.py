"""
Process Mavala Scientifique K+ Third Image V5 - TRULY CENTERED
===============================================================
This script centers the bottle properly in the middle of the canvas.

Usage:
    python scripts/process_scientifique_k_v5.py
"""
...
def process_image_v5(input_path, output_path):
    """
    Process with bottle TRULY CENTERED (50-50).
    """
    print(f"\n{'='*60}")
    print("Mavala Scientifique K+ Image Processor V5")
    print(f"{'='*60}")
    ...
    try:
        ...
        # Step 4: Create canvas and CENTER the bottle (50-50)
        print("\n5. Centering bottle in the MIDDLE (50-50)...")
        canvas_size = max(img_scaled.size[0], img_scaled.size[1])
        canvas = Image.new('RGB', (canvas_size, canvas_size), GREY_RGB)
        
        # TRULY CENTER THE BOTTLE - 50% position both horizontal and vertical
        ...
        print(f"   Bottle position: x={x_offset}, y={y_offset} (CENTERED 50-50)")
        ...
        print(f"Bottle is CENTERED in the middle")
        print(f"{'='*60}\n")
...
def main():
    ...
    success = process_image_v5(input_path, output_path)
